...
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/DamianBakker/pterodactyl-installer"}
...
welcome() {
  ...
  print_brake 70
  output "Pterodactyl.io 2 panel installation script @ $SCRIPT_RELEASE"
  output ""
